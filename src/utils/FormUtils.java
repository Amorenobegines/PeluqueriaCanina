...
public class FormUtils {
    ...
    public static void abrirVentanaSegunRol(String rol, JFrame ventanaActual) {

    if (rol == null) {
        mostrarMensaje("Credenciales incorrectas.", "Error", "Login");
        return;
    }
    ...
    switch (rol) {
        ...
        case "administrador":
            cambiarVentana(ventanaActual, new Principal());
            break;

        case "recepcionista":
            cambiarVentana(ventanaActual, new InicioRecepc());
            break;

        case "trabajador":
            cambiarVentana(ventanaActual, new VerDatos("trabajador"));
            break;

        default:
            mostrarMensaje("Rol no reconocido.", "Error", "Login");
            cambiarVentana(ventanaActual, new FrmLogin());
            break;
    }
}
    ...
    public static void salirSegunRol(String rol, JFrame ventanaActual) {
        ...
        switch (rol) {
            ...
            case "trabajador":
                int res = JOptionPane.showConfirmDialog(ventanaActual,
